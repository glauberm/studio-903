export default function slideshow() {
  ...
  for (const slideshow of slideshows) {
    ...
    const modalCloseButtons = slideshow.querySelectorAll(
      ".slideshow__modal-bg, .slideshow__modal-close"
    );
...
function setActiveImage(slideshow, value) {
  const previousActiveImage = slideshow.querySelector(
...
function setActiveModal(slideshow, value) {
  const previousActiveModal = slideshow.querySelector(
    ".slideshow__modal--active"
  );
